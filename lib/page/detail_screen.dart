...
import 'package:yapilacaklar_listem_proje/page/add_todo_screen.dart';
import 'package:yapilacaklar_listem_proje/page/edit_task_screen.dart';
                    ...
                    child: ListView.builder(
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return Container(
                          ...
                          child: ListTile(
                            onTap: () => model
                                .updateTodo(todo.copy(isCompleted: todo.isCompleted == 1 ? 0 : 1)),
